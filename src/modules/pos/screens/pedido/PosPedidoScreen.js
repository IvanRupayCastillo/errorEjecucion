    ...
    <section className="tabla">
        ...
        <div className="carta">
          <h3>Lista de Platos Categoria: &nbsp;
             <span className="color-secundario">{categoria_global?.categoria_nom || "Seleccione Categoria " }</span></h3>
            <PosPlatos/>
        </div>
        
        <div className="boleta">
          <h3>Pedido Mesa: &nbsp;<span className="color-secundario">{mesa_global?.mesa_nro || "Seleccione Mesa"}</span></h3>
          <hr />
            <PosComanda />
        </div>
      </div>
